...
ComputeClusters<-function(spp, listGraphs, RiskScores.txt, graph_title, dic)
{
  ...
  file_out_graph = paste("/Users/gangopad/Company/RiskScores/TestPNGs/", spp$name, ".txt.png", sep="")
  file_out_text = paste("/Users/gangopad/Company/RiskScores/TestText/", spp$name, ".txt", sep="")
  file_out_nodes = paste("/Users/gangopad/Company/RiskScores/TestNodes/", spp$name, ".txt", sep="")
...
files <- list.files(path="/Users/gangopad/Company/RiskScores/Data", pattern="*.xml", full.names=T, recursive=FALSE)
lapply(files, function(x) {
  ...
  orig_docs<-readLines(paste("/Users/gangopad/Company/RiskScores/Data/", basename(x), sep = ""))
  docs <-readLines(x)
