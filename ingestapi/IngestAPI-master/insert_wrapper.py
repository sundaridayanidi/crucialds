...
if __name__ == "__main__":
    ...
    path = '/Users/gangopad/Company/EMR/DataOne/' #testing
    #path = '/Users/gangopad/Company/RiskScores/Data/'
    ...
    for fname in os.listdir(path):
        ...
        command = 'python /Users/gangopad/Company/REST/ApysAPI/insert.py "text" "' + patient_id + '" "' + event_id + '" """' + emr + '""" "none" "clinical_studio" "inpatient" "en" "none"'
